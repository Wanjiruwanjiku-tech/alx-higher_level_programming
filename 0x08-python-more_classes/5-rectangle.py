#!/usr/bin/python3
""" Module that runs a class rectangle """

class Rectangle:
    """ A class that represents a rectangle """
    def __init__(self, width=0, height=0):
        """ The method initializes the class                           Parameters:
    ...
    def __repr__(self):
		...
		of the rectangle and can be usef to
		create a new instance of the rectangle
        """
        return "Rectangle({}, {})".format(self.width, self.height)

    def __del__(self):
        """ The method returns a message when an instance
